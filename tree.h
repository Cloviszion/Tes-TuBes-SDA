...
TreeNode* Tree_findParent(TreeNode* node, TreeNode* target); // Fungsi baru untuk mencari parent
...
void Tree_calculateStats(TreeNode* node, int* stats); // Array stats sekarang mencakup kabupaten
